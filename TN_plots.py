...
image1 = Image.open('knote_FIG3A_R1.png')
image2 = Image.open('knote_FIG3B_R1.png')
...
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
plt.xlabel('f [kHz]',fontsize=16, ha='right', x=1.0)
plt.ylabel('|H(f)|',fontsize=16)
plt.xlim([-50,50])
plt.grid(True)
plt.legend(['XX','YY'],fontsize=18,loc='upper right',ncol=2);
plt.title('Self-terms',fontsize=18,fontweight='bold')
...
plt.title('Cross-terms',fontsize=18,fontweight='bold')
...
plt.xlim([-50,50])
plt.grid(True)
plt.title('Zero-order terms',fontsize=18,fontweight='bold')
