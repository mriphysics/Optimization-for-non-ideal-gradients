...
res            = 96
partial_fourier = 73/96 # make sure that res * partial_fourier is an integer (=number of measured lines)

smax           = 180
gmax           = 72e-3

experiment_id = 'noGRAPPA_nramp7'
...
# load phantom
phantom = mr0.VoxelGridPhantom.brainweb("data/subject20.npz")
...
if pulseq == 1:
    ...
    pulseq_write_EPG_3D_EC_EPI(seq_full_copy, 'noGRAPPA_nramp71.seq', FOV_export, GIRF, plot_seq=False, smax=smax)
...
if pulseq == 1:
    ...
    pulseq_write_EPG_3D_EC_EPI(seq_full_copy, 'noGRAPPA_nramp72.seq', FOV_export, GIRF, plot_seq=False, smax=smax+1)
